...
import { DATA, MOCK_FIXTURES, type LiveFixture, type GroupStageMatch } from "@/lib/data";
...
function fl(t: string): string {
  return DATA.flags[t] || "⚽";
}

function ven(k: string) {
  return DATA.venues[k] || { common: "", fifa: "", city: "", country: "", cap: 0 };
}

function vName(k: string): string {
  return (DATA.venues[k] || { common: "" }).common || "";
}
...
function findLive(m: { ts: number; v?: string; t1?: string; t2?: string }, fixtures: LiveFixture[]): LiveFixture | null {
