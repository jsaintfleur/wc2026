...
export interface VenueDetails {
  ...
  /* Hosted-match counts are derived from the schedule at render time
     (see MapView's venueModels) — never hand-maintained here. */
}
